...
// unique action
const lv1U = {moveName: 'Wirbelwind', altName: '5ULv1', damage: '1000', guard: 'mid', startup: '22', active: '9', recovery: '13', onblock: '-5', onhit: '-'};
const lv2U = {moveName: 'Air Wirbelwind', altName: '5ULv2', damage: '1200', guard: 'mid', startup: '22', active: '9', recovery: '13', onblock: '-5', onhit: '-'};
const lv3U = {moveName: 'Wirbelwind (Stop)', altName: '5ULv3', damage: '1400', guard: 'mid', startup: '22', active: '9', recovery: '13', onblock: '-5', onhit: '-'};
const lv4U = {moveName: 'Wirbelwind (Feint)', altName: '5ULv4', damage: '1600', guard: 'mid', startup: '22', active: '9', recovery: '13', onblock: '-5', onhit: '-'};
const lv5U = {moveName: 'Wirbelwind (Crossup)', altName: '5ULv4', damage: '1600', guard: 'mid', startup: '22', active: '9', recovery: '13', onblock: '-5', onhit: '-'};
const lv6U = {moveName: 'Wirbelwind (Jump)', altName: '5ULv5', damage: '2000', guard: 'mid', startup: '22', active: '9', recovery: '13', onblock: '-5', onhit: '-'};
...
// fireballs
const lFireball = {moveName: 'L Wogenstrom', altName: '236L', damage: '800', guard: 'all', startup: '15', active: '-', recovery: '-', onblock: '-7', onhit: '-3'};
const mFireball = {moveName: 'M Wogenstrom', altName: '236M', damage: '400, 800', guard: 'mid, all', startup: '13', active: '-', recovery: '-', onblock: '-4', onhit: '0'};
const hFireball = {moveName: 'H Wogenstrom', altName: '236H', damage: '350 x 3', guard: 'all', startup: '15', active: '-', recovery: '-', onblock: '+3', onhit: '+7'};

// dragon punches
const lUppercut = {moveName: 'L Blade Impulse', altName: '66L', damage: '700, 300', guard: 'mid, all', startup: '9', active: '-', recovery: '-', onblock: '-17', onhit: 'KD'};
const mUppercut = {moveName: 'M Blade Impulse', altName: '66M', damage: '700, 300 x 2', guard: 'mid, all', startup: '9', active: '-', recovery: '-', onblock: '-26', onhit: 'KD'};
const hUppercut = {moveName: 'H Blade Impulse', altName: '66H', damage: '950~1400', guard: 'mid, all', startup: '9', active: '-', recovery: '-', onblock: '-26', onhit: 'HKD'};

// rekka
const lRekka = {moveName: 'L Southern Cross', altName: '214L', damage: '700', guard: 'mid', startup: '13', active: '2', recovery: '19', onblock: '-6', onhit: '-2'};
const mRekka = {moveName: 'M Southern Cross', altName: '214M', damage: '1200', guard: 'mid', startup: '16', active: '13', recovery: '29', onblock: '+2~-10', onhit: '-'};
const hRekka = {moveName: 'H Southern Cross', altName: '214H', damage: '1200', guard: 'mid', startup: '13', active: '13', recovery: '37', onblock: '+4~-8', onhit: 'HKD'};

// skybound art
const sba =  {moveName: 'Weiss Flugel', altName: '236236H', damage: '2500-3500', guard: 'mid', startup: '6+5', active: '-', recovery: '-', onblock: '-13', onhit: 'HKD'};
const ssba =  {moveName: 'Schöner Winterhügel', altName: '236236U', damage: '3500-4500', guard: 'all', startup: '8+5', active: '-', recovery: '-', onblock: '-23', onhit: 'HKD'};
